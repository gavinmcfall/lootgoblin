...
/**
 * extension-mediated.ts — shared helper for extension-mediated ScoutAdapters.
 *
 ...
 *         → yields ScoutEvent stream (progress + completed | failed)
 *
...
/**
 * Build a `ScoutAdapter` for an extension-mediated source.
 *
...
export function createExtensionMediatedAdapter(
  ...
  return {
    ...
    // Providing it here too keeps the return type compatible with ScoutAdapter.
    id: sourceId,
