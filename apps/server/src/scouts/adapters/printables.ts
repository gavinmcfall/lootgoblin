...
/**
 * printables.ts — Printables ScoutAdapter (V2-003-T6)
 *
 ...
 *
 * Registration: added to createDefaultScoutRegistry() in scavengers/index.ts.
 */

import type { ScoutAdapter } from '../types';
import {
 ...
 *
 * There should be one instance per process — register it in createDefaultScoutRegistry().
 */
export function createPrintablesAdapter(options?: ExtensionMediatedAdapterOptions): ScoutAdapter {
  return {
