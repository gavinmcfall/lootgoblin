...
/**
 * upload.ts — Upload ScoutAdapter (V2-003-T4)
 *
...
import type { ScoutAdapter, ScoutEvent, FetchContext, FetchTarget } from '../types';
 ...
 */
export function createUploadAdapter(): ScoutAdapter {
  return {
    id: 'upload' as const,
