 ...
 *   - ScoutAdapter implementations (T4-T10)
 ...
 *
 * Adapters are registered in the `ScoutRegistry` at startup and are
 ...
 */
/**
 * Auth-method discriminator used by the public source catalog (GET /api/v1/scouts).
 ...
 */
export type ScoutAuthMethod = 'oauth' | 'api-key' | 'extension' | 'none';

/**
 * Public adapter metadata exposed via GET /api/v1/scouts.
 *
...
export interface ScoutAdapter {
   ...
   */
  readonly metadata?: ScoutMetadata;
  ...
  /**
   * Fetches the target item, emitting a stream of ScoutEvents.
   *
